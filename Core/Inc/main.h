...
#define SCH_DRY_Pin GPIO_PIN_1
#define SCH_DRY_GPIO_Port GPIOB
#define EXTRESN_Pin GPIO_PIN_10
#define EXTRESN_GPIO_Port GPIOB
...
#define MOTOR_FLT_Pin GPIO_PIN_7
#define MOTOR_FLT_GPIO_Port GPIOB
